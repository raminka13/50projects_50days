...
const penner = (function () {
  ...
  const eases = { linear() { return function (t) { return t; }; } };

  const functionEasings = {
    Sine() { return function (t) { return 1 - Math.cos(t * Math.PI / 2); }; },
    Circ() { return function (t) { return 1 - Math.sqrt(1 - t * t); }; },
    Back() { return function (t) { return t * t * (3 * t - 2); }; },
    Bounce() {
      return function (t) {
        let pow2; let
          b = 4;
...
function getAnimatables(targets) {
  ...
  return parsed.map((t, i) => ({
    target: t, id: i, total: parsed.length, transforms: { list: getElementTransforms(t) },
  }));
}
